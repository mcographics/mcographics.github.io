...
const sitemapPaths = ["/", "/about/", "/blog/", "/community/", "/projects/work-day-with-god/", "/projects/words-of-yeshua/", ...visiblePosts.map((post) => `/blog/${post.slug}/`), ...categories.map((category) => `/blog/category/${category.slug}/`), ...tags.map((tag) => `/blog/tag/${tag.slug}/`)];
