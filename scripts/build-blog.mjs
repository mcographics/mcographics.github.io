...
const sitemapPaths = ["/", "/about/", "/blog/", "/community/", ...visiblePosts.map((post) => `/blog/${post.slug}/`), ...categories.map((category) => `/blog/category/${category.slug}/`), ...tags.map((tag) => `/blog/tag/${tag.slug}/`)];
