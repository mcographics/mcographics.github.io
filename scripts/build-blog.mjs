...
const projectSlugs = ["the-islamic-dilemma", "work-day-with-god", "unified-ai-studio", "creative-whiteboard", "comic-organizer", "dossier-builder", "words-of-yeshua", "truth-news", "re-tui", "bridgeforge", "grace-seek", "space-eye", "tanyaos", "workspaces", "project-database", "gamingbible", "character-profile-maker"];
