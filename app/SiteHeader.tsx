  ...
  const navigation = (mobile = false) => links.map((link) => {
    if (link.label === "Projects") {
      ...
      return <div key={link.label} className="projects-dropdown" data-open={projectsMenuOpen}
        ...
        <div className="projects-dropdown-panel" id="projects-submenu" hidden={!projectsMenuOpen}><a href="/projects/unreal-engine/" onClick={() => setProjectsMenuOpen(false)}>Unreal Engine</a><a href="/projects/tanyaos/" onClick={() => setProjectsMenuOpen(false)}>Research Project: Tanya OS</a></div>
      </div>;
    }
