...
export default function DiscordCommunityLink({ slug, title }: Props) {
  ...
  return <section className="project-discord-community" aria-labelledby="project-discord-heading">
    ...
    <div><p>Ask questions, share ideas, report a problem, or help shape the next release with the Majestic Creations community.</p><div className="project-discord-actions">
      <a className="button primary" href={projectDiscordUrl(slug, "discussion")} target="_blank" rel="noreferrer">Discuss this app <span>↗</span></a>
      <a className="button ghost" href={projectDiscordUrl(slug, "support")} target="_blank" rel="noreferrer">Get support <span>↗</span></a>
      <a className="button ghost" href={projectDiscordUrl(slug, "feedback")} target="_blank" rel="noreferrer">Share feedback <span>↗</span></a>
