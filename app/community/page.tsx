...
import { discordConfig, discordUrlForChannel } from "./discord-config";
...
const joinUrl = discordConfig.inviteUrl || `https://discord.com/channels/${discordConfig.guildId}`;
const spaces = [
...
export default function CommunityPage() {
  return <main className="community-page" id="top">
    <SiteHeader className="journal-header" activePage="community" actionHref={joinUrl} actionLabel="Open Discord" />
    <section className="community-hero"><div className="about-grid" aria-hidden="true" /><div><p className="eyebrow"><span /> Majestic Creations Community</p><h1>Create.<br /><em>Connect. Build Together.</em></h1><p>A focused home for announcements, application discussions, honest feedback, practical support, and the people helping Majestic Creations grow.</p><div className="community-cta-row"><a className="button primary" href={joinUrl} target="_blank" rel="noreferrer">Join the Discord <span>↗</span></a><a className="button ghost" href={discordUrlForChannel("general")} target="_blank" rel="noreferrer">Open Discord <span>↗</span></a></div></div><img src="/brand/majestic-lion.png" alt="Majestic Creations gold lion" /></section>
