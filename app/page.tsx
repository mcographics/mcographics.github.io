...
const projects: Project[] = [
  ...
  },
  {
    ...
    releaseVersions: [{ label: "Android 7.0+ · APK · v1.0.0", url: "https://github.com/mcographics/Bible-Recorder-Note-Taker/releases/download/v1.0.0/Bible-Recorder-Note-Taker-1.0.0.apk" }],
    availability: { android: true },
