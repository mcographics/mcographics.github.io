...
const featuredSlides = [
  ...
  { src: "/projects/work-day-with-god-slides/07-light-mode-runtime.png?v=2", alt: "Work Day with God daily devotional running in light mode on Android" },
  { src: "/projects/work-day-with-god-slides/08-dark-mode-runtime.png?v=2", alt: "Work Day with God daily devotional running in dark mode on Android" },
];
